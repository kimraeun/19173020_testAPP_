    ...
    public void InitalLizeListenner()
    {
        callbackMethon = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                String date = year1 + month1 + month1 + dayOfMonth1;
                editText.setText("https://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=054cb84e457ec0392f294e542774b94f&targetDt=" + date);
